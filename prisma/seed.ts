...
const categories: CategorySeed[] = [
  ...
  },
  {
    ...
    slug: "garage-sale",
    icon: "box",
    seoTitle: "Garage Sales in San Luis Obispo County | SLO Market",
    seoDescription: "Browse garage sales, yard sales, estate sales, and moving sales across SLO County. Multiple items from local sellers.",
    children: [
      { name: "Household Items", slug: "garage-household" },
      { name: "Furniture", slug: "garage-furniture" },
      { name: "Clothing & Accessories", slug: "garage-clothing" },
      { name: "Tools & Equipment", slug: "garage-tools" },
      { name: "Books & Media", slug: "garage-books" },
