...
export const EXPLORE_VIDEO_MAX_SECONDS = 15;

/** iPhone 4K clips are large; accept up to this size (we compress in the browser when we can). */
export const EXPLORE_VIDEO_MAX_BYTES = 200 * 1024 * 1024;
